...
@section('content')
     <div class="card-box">                 
        <div class="panel-body">
            <div class="clearfix">
                <div class="pull-left">
                    <h2 class="logo" style="color: #2b3d51 !important;">Update FSG Register for Client No. {{$read_FalimlySuportGroupRegister->hivcareartcard->PatientNumber}} ({{$read_FalimlySuportGroupRegister->hivcareartcard->surName}} {{$read_FalimlySuportGroupRegister->hivcareartcard->firstName}})</h2>
                </div>
            ...
            <section class="form-control">
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6">
                        ...
                        <label>Date of Enrolement</label>
         ...
         $('#fsg_service_id_medical :selected').each(function(i, selectedElement) {
          ...
          var fsg_service_community=[]; 
           ...
           $('#fsg_service_id_community :selected').each(function(i, selectedElement) {
            ...
            $.ajax({
                type: "PUT",
                url: "{{ route('fsg_register.update',$read_FalimlySuportGroupRegister->id) }}",
                data: {                   
